...
<html>
    <head>
        ...
        <title>Pesquisa por Titulo</title>
    ...
    <body>
        <?php
            ...
            $pesquisa_na_db = mysqli_query($connect,"SELECT * FROM filmes WHERE titulo LIKE '%$pesquisar%'")or die(mysqli_error($connect));
                ...
                <div class="card-left">
                    <div class="card-details">
                        ...
                        <div class="social-btn">
                            <!-- watch trailer -->
                            <button>
                                <a href="ver_filme.php"></a> Ver Filme
                            </button>
                        </div>                  
                    </div>
                </div>
